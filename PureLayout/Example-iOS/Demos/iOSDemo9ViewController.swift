...
class iOSDemo9ViewController: UIViewController {
    ...
    override func updateViewConstraints() {
        if (!didSetupConstraints) {
            ...
            blueView.autoPinToTopLayoutGuideOfViewController(self, withInset: 0.0)
            blueView.autoPinEdgesToSuperviewEdgesWithInsets(UIEdgeInsets(top: 0, left: 10.0, bottom: 10.0, right: 10.0), excludingEdge: .Top)
            
            
//            blueView.autoPinEdgesToSuperviewEdgesWithInsets(UIEdgeInsets(top: 0, left: 10.0, bottom: 10.0, right: 10.0)
